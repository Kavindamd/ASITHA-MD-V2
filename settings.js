...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=T6hxQA4T#vwzdfdKdWs9R_PDw_2WdHggGDVcsErkCVI4DtrJB1TA' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now!!*" : process.env.ALIVE_MSG,
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ?"false" : process.env.AUTO_READ_STATUS,
MODE: process.env.MODE === undefined ?"group" : process.env.MODE,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? 'ASITHA_MD' : process.env.DELETEMSGSENDTO,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "kawada bn❤️😎" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "ආ පැටියෝ කොහොමද🤭❤️" : process.env.SEEDER_PASSWORD,
